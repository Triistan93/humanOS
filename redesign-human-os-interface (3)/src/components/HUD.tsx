      ...
      <div className="fixed right-5 top-5 z-[75] md:right-7 md:top-7">
        <div className="glass flex items-center gap-3 rounded-full py-2.5 pl-4 pr-5 shadow-2xl md:gap-5 md:py-3 md:pl-5 md:pr-6">
          ...
          <button
            ...
            title="Ver Obras & Fontes"
            className="hidden items-center gap-1.5 font-mono text-[10px] uppercase tracking-wider text-cyan-neon hover:text-white transition-colors border border-cyan-neon/30 rounded-full px-2.5 py-0.5 bg-cyan-neon/10 md:flex"
          >
            <BookOpen size={12} /> Fontes
          </button>
          <span className="hidden h-4 w-px bg-white/10 md:block" />
